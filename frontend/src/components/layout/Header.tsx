        ...
        <div className="flex justify-between items-center h-16">
          ...
          <nav className="hidden md:flex items-center space-x-8">
            {!isAuthenticated ? (
              ...
              <>
                <button onClick={() => navigate('/dashboard')} className="text-unitasa-gray hover:text-unitasa-electric transition-colors font-medium">
                  Dashboard
                </button>
                <button onClick={() => navigate('/settings')} className="text-unitasa-gray hover:text-unitasa-electric transition-colors font-medium">
                  Settings
                </button>
              </>
            )}
